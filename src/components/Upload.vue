  ...
  methods: {
    ...
    uploadGif: function (item) {
      let client = new OSS({
        ...
        accessKeyId: process.env.VUE_APP_ALIBABA_ACCESS_KEY_ID || 'your-access-key-id',
        accessKeySecret: process.env.VUE_APP_ALIBABA_ACCESS_KEY_SECRET || 'your-access-key-secret',
        bucket: 'gif-dio'
      })
      try {
